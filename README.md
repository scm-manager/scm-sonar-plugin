...
Integrates code analysis with SonarCloud / SonarQube

## Usage

Find out how this plugin works on the [plugin documentation page](https://scm-manager.org/plugins/scm-sonar-plugin/docs/).
